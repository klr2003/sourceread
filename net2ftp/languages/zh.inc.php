...
$net2ftp_messages["Upload"] = "上传";
$net2ftp_messages["Java Upload"] = "Java 上传";
$net2ftp_messages["Flash Upload"] = "Flash 上传";
$net2ftp_messages["Install"] = "安装";
...
$net2ftp_messages["Unzip"] = "解压zip包";
$net2ftp_messages["Zip"] = "打包成Zip";
$net2ftp_messages["Size"] = "大小";
$net2ftp_messages["Search"] = "搜索";
$net2ftp_messages["Go to the parent directory"] = "上级目录";
$net2ftp_messages["Go"] = "前往";
$net2ftp_messages["Transform selected entries: "] = "传输所选的项目: ";
$net2ftp_messages["Transform selected entry: "] = "传输所选的项目: ";
...
$net2ftp_messages["Upload directories and files using a Java applet"] = "使用Java applet上传目录和文件";
$net2ftp_messages["Upload files using a Flash applet"] = "使用flash应用来上传文件";
$net2ftp_messages["Install software packages (requires PHP on web server)"] = "安装软件(服务器端需要php支持)";
...
$net2ftp_messages["Upload files"] = "上传文件";
...
$net2ftp_messages["Select the directory %1\$s"] = "选择目录 %1\$s";
$net2ftp_messages["Select the file %1\$s"] = "选择文件 %1\$s";
$net2ftp_messages["Select the symlink %1\$s"] = "选择符号链接 %1\$s";
$net2ftp_messages["Go to the subdirectory %1\$s"] = "打开子目录 %1\$s";
$net2ftp_messages["Download the file %1\$s"] = "下载文件 %1\$s";
$net2ftp_messages["Follow symlink %1\$s"] = "打开链接 %1\$s";
...
$net2ftp_messages["Character encoding: "] = "字符编码: ";
