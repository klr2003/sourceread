	...
	switch(mode) {
		case 'selected':
			for(wp = 0; wp < document.MassUpdate.elements.length; wp++) {
				var reg_for_existing_uid = new RegExp('^'+document.MassUpdate.elements[wp].value+'[\s]*,|,[\s]*'+document.MassUpdate.elements[wp].value+'[\s]*,|,[\s]*'+document.MassUpdate.elements[wp].value+'$|^'+document.MassUpdate.elements[wp].value+'$');
