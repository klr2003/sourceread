...
<table style="border-spacing: 0pt;">
	<tr>
		<td  valign="top" NOWRAP>
			<table cellpadding="0" cellspacing="0" border="0" id="{$module}emailAddressesTable" class="emailaddresses">
				<tbody id="targetBody"></tbody>
				<tr>
					<td scope="row" NOWRAP>
						<input type=hidden name='emailAddressWidget' value=1>
						<input type='button' onClick="javascript:addEmailAddress({literal}'{/literal}{$module}emailAddressesTable{literal}'{/literal},'','');" value='{$app_strings.LBL_ADD_BUTTON}'>
					</td>
					<td scope="row" NOWRAP>
					    &nbsp;
					</td>
