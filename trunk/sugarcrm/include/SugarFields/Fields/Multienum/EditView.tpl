...
<select id="{{sugarvar key='name'}}[]" name="{{sugarvar key='name'}}[]" multiple="true" size='{{$displayParams.size|default:6}}' style="width:150" title='{{$vardef.help}}' tabindex="{{$tabindex}}">
