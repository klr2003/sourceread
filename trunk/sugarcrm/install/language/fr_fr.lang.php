...
$mod_strings = array (
    ...
    'ERR_DB_ADMIN_MSSQL' => 'Le login ou le mot de passe de l&#39;administrateur de la base de données est invalide. Ne peut pas se connecter au serveur : ',
    ...
    'ERR_DB_EXISTS_PROCEED' => 'Une base de données avec le même nom existe déjà. <br>Utiliser le bouton Précédent et choisissez un nouveau nom de base de donnée ou vous pouvez choisir de cliquer sur le bouton Suivant et continuer, mais <strong> toutes les tables existantes et leurs données seront définitivement effacées.</strong>',
    ...
    'LBL_DROP_DB_CONFIRM' => 'Cette base de données existe déjà. Voulez-vous continuer et effacer les tables existantes ? Cela effacera toutes vos données présentes.',
    ...
    'LBL_DBCONF_HOST_NAME_MSSQL' => 'Nom de l&#39;Hôte \\ Nom de l&#39;instance',
    ...
    'LBL_DBCONFIG_MSG2' => 'Entrer le nom de votre serveur de base de données.',
    'LBL_DBCONFIG_MSG3' => 'Entrer un nom pour la bse de données Sugar.',
    'LBL_DBCONFIG_B_MSG1' => 'Entrer le nom et le mot de passe admin pour la base de donnée. Cet admin doit avoir les permissions adéquates pour créer et écrire la base de données de Sugar.',
    ...
    'LBL_MSSQL_FTS' => 'Recherche plein texte',
    'LBL_MSSQL_FTS_INSTALLED' => 'Installé',
    'LBL_MSSQL_FTS_INSTALLED_ERR1' => 'La fonctionnalité de recheche plein texte n&#39;est pas installé.',
    'LBL_MSSQL_FTS_INSTALLED_ERR2' => 'Vous pouvez installer mais vous ne pourrez pas utiliser la recherche plein texte sans reinstaller SQL Server avec la recherche plein texte activé. Veuillez vous référer au manuel d&#39;installation de SQL Server ou contacter votre administrateur.',
    ...
    'LBL_INSTALL_TYPE_MSG1' => 'Cette clé n&#39;est pas requise pour l&#39;installation mais serat requise pour les fonctionnalitées générales. Vous pourrez entrer cette clé ultérieurement aprés avoir finit votre insatallation et vous êtres identifiées dans l&#39;application.',
    'LBL_INSTALL_TYPE_MSG2' => 'Informations minimum requises pour l&#39;installation. Recommandé pour les nouveaux utilisateurs.',
    'LBL_INSTALL_TYPE_MSG3' => 'Fournit des options supplémentaires pour personnaliser votre installation. Ces options sont également disponibles après l&#39;installation dans l&#39;écran d&#39;admin. Recommandé pour les utilisateurs.',
    ...
    'LBL_LICENSE_CHECKING' => 'Vérifier les compatibilitées systèmes',
    'LBL_LICENSE_CHKENV_HEADER' => 'Vérifications de l&#39;environnement',
    'LBL_LICENSE_CHKDB_HEADER' => 'Vérification des droits de la base de données',
    'LBL_LICENSE_CHECK_PASSED' => 'Test pour la compatibilité système passé',
    'LBL_LICENSE_REDIRECT' => 'Redirigé dans ',
    ...
    'LBL_SITECFG_URL_MSG' => 'Entrer l&#39;URL de base pour votre application Sugar. Par exemple utiliser "localhost" pour accéder seulement depuis cette machine (qui est localhost).',
    'LBL_SITECFG_SYS_NAME_MSG' => 'Enter un nom pour votre système. Ce nom apparaitrat dans la barre de titre du navigateur quand les utilisateurs visiterons votre application Sugar.',
    'LBL_SITECFG_PASSWORD_MSG' => 'Entrer un mot de passe pour votre administrateur Sugar pour vous identifier dans l&#39;application.',
    'LBL_SYSTEM_CREDS' => 'Droits Système',
    'LBL_SYSTEM_ENV' => 'Environnement Systéme',
    'LBL_START' => 'Démarrer',
    'LBL_SHOW_PASS' => 'Voir les mots de passe',
    ...
    'REQUIRED_SYS_COMP_MSG' => "Avant de commencer, vérifiez que vous avez les composants requis dans les versions nécessaires :<br>\n\n                      <ul>\n\n                      <li> Platforme (Exemples: Linux, Windows, Mac OS X)</li>\n\n                      <li> PHP</li>\n\n                      <li> Base de données/Gestionnaire de base de données (Exemples: MySQL, SQL Server, Oracle)</li>\n\n                      <li> Serveur web (Exemples: Apache, IIS) ou ordinateur local</li>\n\n                      </ul>\n\n                      Consulter la matrice de compatibilité dans les notes de la Release pour vérifier la compatibilité des versions des composants nécessaires à votre installation de Sugar.<br>",
    'REQUIRED_SYS_CHK' => 'Vérification système initiale',
    'REQUIRED_SYS_CHK_MSG' => "Quand vous commencez la procédure d&#39;installation, une vérification du système sera effectuée du le serveur web sur lequel ce situe les fichier de Sugar afin de garantir que votre système est correctement configuré et qu&#39;il contient tous les éléments nécessaires pour poursuivre l&#39;installation.<br><br> Le système vérifie donc : <br />\n\n                      <ul>\n\n                      <li><b>Variables de session</b> &#8211; Les variables de sessions doivent fonctionner correctements.</li>\n\n                      <li><b>Version de PHP</b> &#8211; Vous devez utiliser une version de PHP compatible avec l&#39;application.</li> \n\n                      <li> <b>Support Base de donnée</b> &#8211; Un support doit exister pour MySQL, SQL Server ou Oracle.</li> \n\n                      <li> <b>MB Strings</b> &#8211; Cette extension doit être installée et activée dans le php.ini.</li> \n\n                      <li> <b>XML parsing</b> &#8211; Cette extension doit être installée et activée dans le php.ini.</li> \n\n                      <li> <b>Config.php</b> &#8211; Ce fichier Sugar doit exister et avec les permissions appropriées en écriture.</li> \n\n                      <li><b>Les fichiers/répertoires suivants doivent être en écriture:</b><ul><li>/custom</li>\n\n<li>/data/upload</li>\n\n<li>/data/upload</li>\n\n<li>/cache</li>\n\n<li>/cache/images</li>\n\n<li>/cache/import</li>\n\n<li>/cache/layout</li>\n\n<li>/cache/pdf</li>\n\n<li>/cache/upload</li>\n\n<li>/cache/xml</li>\n\n<li>/modules</ul></li>                                  </ul>\n\n                                  Si la vérification échoue, vous ne pourrez pas poursuivre l&#39;installation. Un message d&#39;erreur sera affiché expliquant pourquoi votre système a échoué lors de la vérification.\n\n                                  Après avoir fait les changements nécessaire vous pourrez re-lancer la vérification et ainsi poursuivre votre installation.<br><br>\n\n                                  Pour plus d&#39;information à propos des messages d&#39;erreur de la vérifications, veuillez consulter le Guide d&#39;Installation.<br>",
    'REQUIRED_INSTALLTYPE' => 'Installation Typique ou Personnalisée',
    'REQUIRED_INSTALLTYPE_MSG' => "Après que la vérification système soit passé avec succès vous pouvez choisir le type d&#39;installation que vous souhaitez effectuer : Typique ou Personnalisée, les différences entre ces deux types sont les suivantes :\n\n                      <ul>\n\n                      <li> <b>Type de base de donnée qui peut contenir les données de Sugar</b> <ul><li>Base de donnée compatible : MySQL, MS SQL Server, Oracle.<br><br></li></ul></li> \n\n                      <li> <b>Nom du serveur web ou de la machine (host) sur laquelle la base de donnée se situe</b> \n\n                      <ul><li>Cela peut être <i>localhost</i> si la base de donnée est sur votre ordinateur ou sur la même machine que le serveur web contenant vos fichiers Sugar.<br><br></li></ul></li> \n\n                      <li><b>Nom de la base de donnée que vous voulez utiliser pour stocker vos données Sugar</b></li> \n\n                        <ul>\n\n                          <li> Vous avez peut-être déjà d&#39;une base de données existante que vous souhaitez utiliser. Si vous fournissez un nom de base de donnée existante, les tables de cette base de données seront supprimées durant l&#39;installation de la base de donnée Sugar.</li> \n\n                          <li> Si vous n&#39;avez pas déjà une base de donnée, le nom que vous avez fournit sera utilisé pour créer la nouvelle base de donnée durant l&#39;installation.<br><br></li> \n\n                        </ul>\n\n                      <li><b>L&#39;utilisateur et le mot de passe administrateur de la base de donnée</b> <ul><li>L&#39;administrateur de base de donnée doit avoir le droit de créer des table et des users ainqi que d&#39;écrire dans la base.</li><li>Vous devez contacter votre administrateur de base de donnée pour cette information si la base de donnée n&#39;est pas située en local et/ou si vous n&#39;êtes pas l&#39;administrateur de la base de données.<br><br></ul></li></li> \n\n                      <li> <b>Nom de l&#39;utilisateur de la base de donnée qui sera exclusivement dédié à la base de donnée Sugar</b> \n\n                      </li> \n\n                        <ul>\n\n                          <li>L&#39;utilisateur doit être l&#39;administrateur de la base de données, ou vous pouvez fournir un nom d&#39;un autre utilisateur de la base de données.</li> \n\n                          <li>Si vous voulez créer un nouvel utilisateur pour cela, vous devez fournir un nouveau nom et mot de passe durant la procédure d&#39;installation, et cet utilisateur sera créé durant l&#39;installation.</li> \n\n                        </ul></ul><p>\n\n                        \n\n                      Pour l&#39;installation <b>Personnalisée</b>, vous devez aussi savoir :<br>\n\n                      <ul>\n\n                      <li> <b>URL qui sera utilisé pour accéder à l&#39;instance de Sugar après sont installation. \n\n                      Cette URL doit inclure le serveur web ou le nom de la machine ou l&#39;adresse IP.<br><br></li> \n\n                                  <li> [Optionnel] <b>Chemin du répertoire de session</b> Si vous souhaitez utiliser un répertoire personnel pour les sessions afin de prévenir les risques liés aux serveurs partagés.<br><br></li> \n\n                                  <li> [Optionnel] <b>Chemin vers le répertoire de log</b> Si vous souhaitez surcharger la valeur par défaut du répertoire de log de Sugar.<br><br></li> \n\n                                  <li> [Optionnel] <b>Application ID</b> Si vous souhaitre surcharger l&#39;ID généré automatiquement qui assure que les sessions de cette instance de Sugar n&#39;est pas utilisé par d&#39;autre instances.<br><br></li> \n\n                                  <li><b>Le Jeu de caractères les plus couramment utilisés par votre locale</b>.<br><br></li> \n\n                                  Pour plus d&#39;information, veuillez consulter le Guide d&#39;Installation.<br>\n\n                                </ul>",
    ...
    'LBL_MODULE_TITLE' => 'Télécharger et Installer les Packs Langues',
