...
function create_date($year=null,$mnth=null,$day=null) {
    ...
    $date = date($timedate->get_date_format(), mktime(0, 0, 0, $mnth, $day, $year));
    return $date;
}
...
function create_current_date_time() {
    ...
    $time=date($timedate->get_date_format() . ' ' . $timedate->get_time_format(),mktime());
    return $time;
}
...
function create_time($hr=null,$min=null,$sec=null) {
    ...
    $time=date($timedate->get_time_format(),mktime($hr, $min, $sec, 7, 10, 2007));
    return $time;
}
