...
<script type="text/javascript" src="{sugar_getjspath file='include/javascript/yui/build/utilities/utilities.js'}"></script>
<script type="text/javascript" src="{sugar_getjspath file='include/javascript/yui/build/event/event.js'}"></script>
<script type="text/javascript" src="{sugar_getjspath file='include/javascript/yui/build/tabview/tabview.js'}"></script>
