...
$mod_strings = array (
	...
	'LBL_PIPELINE_FORM_TITLE' => '销售数据',
	'LBL_CAMPAIGN_ROI_FORM_TITLE' => '市场活动投资汇报率',
...
//ABOUT page
  ...
  'LBL_ALL_NEWS' => '所有新闻',
  'LBL_LINK_CURRENT_CONTRIBUTORS' => '当前Sugar投搞人请点击这个链接!',
  'LBL_SOURCE_CODE' => '源代码',
  'LBL_SOURCE_SUGAR' => 'Sugar - 世界上最受欢迎的销售自动化应用被SugarCRM 公司创造出来.',
  'LBL_SOURCE_XTEMPLATE' => 'XTemplate - 一个PHP的模板引擎被Barnabás Debreceni创建出来',
  'LBL_SOURCE_LOG4PHP' => 'Log4php - 一个PHP的Log4j端口, 最流行的Java logging框架, 被Ceki Gülcü创建出来',
  'LBL_SOURCE_NUSOAP' => 'NuSOAP - 一组PHP类，它允许开发者创建和使用web服务，被NuSphere公司和Dietrich Ayala创建出来',
  'LBL_SOURCE_JSCALENDAR' => 'JS Calendar - 输入日期的日历被Mihai Bazon创建出来',
  'LBL_SOURCE_PHPPDF' => 'PHP PDF - 用于创建PDF文档的库被Wayne Munro创建',
  'LBL_SOURCE_DOMIT' => 'DOMIT! - 一个基于文档对象模型（DOM）2的xml解析器用于PHP语言.',
  'LBL_SOURCE_DOMITRSS' => 'DOMIT RSS - 基于RSS feed解析器的基础上domit纯PHP的XML解析器.',
  'LBL_SOURCE_PNGBEHAVIOR' => 'PNG Behavior - PNGAdds在IE上支持PNG图形格式.',
  'LBL_SOURCE_JSONPHP' => 'JSON.php - 一个PHP脚本转换为JSON数据模式或反之转换靠Michal Migurski来实现.',
  'LBL_SOURCE_JSON' => 'JSON.js - 一个JSONA JSON解析器和JSON stringifier 在JavaScript中.',
  'LBL_SOURCE_HTTP_WEBDAV_SERVER' => 'HTTP_WebDAV_Server - 在PHP中一个WebDAV服务器的实施.',
  'LBL_SOURCE_JS_O_LAIT' => 'JavaScript O Lait - 图书馆可重用的模块和组件来提高JavaScript靠Jan-Klaas Kollho.',
  'LBL_SOURCE_PCLZIP' => 'PclZip - 图书馆为Zip格式的文章提供压缩和抽取功能靠Vincent Blavet',
  'LBL_SOURCE_SMARTY' => 'Smarty - 一个PHP的模板引擎.',
  'LBL_SOURCE_OVERLIBMWS' => 'Overlibmws - JavaScript库为客户端的窗口.',
  'LBL_SOURCE_WICK' => 'WICK: Web Input Completion Kit - JavaScript 类型工具',
  'LBL_SOURCE_YAHOO_UI_LIB' => 'Yahoo! User Interface Library - 用户界面库通用的便利实施的丰富的客户端功能.',
