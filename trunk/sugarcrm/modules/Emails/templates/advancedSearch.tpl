...
<table cellpadding="4" cellspacing="0" border="0">
	<tr>
		<th NOWRAP>
			<b>{$app_strings.LBL_EMAIL_SEARCH__FROM_ACCOUNTS}:</b><br/><select name="accountListSearch" id="accountListSearch" onchange="SUGAR.email2.search.accountListSearchChange(this)"></select>
		</th>
	</tr>
	<tr>
		<td>&nbsp;
