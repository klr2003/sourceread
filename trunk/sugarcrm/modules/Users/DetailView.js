 ...
 * "Powered by SugarCRM".
 */
var appel;function generatepwd(id){callback={success:function(o){checkok=o.responseText;if(checkok.charAt(0)!='1')
alert(checkok);else
document.getElementById('pwd_sent').innerHTML=LBL_NEW_USER_PASSWORD;},failure:function(o){alert("Ajax failure");}}
