...
//dPegetParam 如果设置了，则为设置的值，否则为$def 
...
<?php
//@see CTabBox_core ui.class.php 
/**
 * @param $baseHRef  
 * @param $baseInc
 * @param $active=0,
 * @param javascript = null 
 * @var unknown_type
 */
...
//如何添加模块，模块怎么显示，一个模块一个文件？
if ($canViewTask) {
	/**
	 * $tabBox->add 
	 * @param $file 文件名
	 * @param $title 
	 * tabs[] = array($file,$tile);
	 * @see $tabBox->show;
	 */
