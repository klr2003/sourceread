...
<p><img src="include/images/sugarsales_lg.png" alt="SugarCRM" width="425" height="30" ondblclick='abouter.display();'><br>
...
<ul class="noBullet">
	...
	<li class="noBullet" style="margin-bottom: 6px;"><a href="http://www.sugarcrm.com/crm/index2.php?no_html=1&stype=rss20&task=returnRSS&option=com_rss_feed_manager&channel=Training" target="_blank"><img src="include/images/rss_xml.gif" border="0" alt="XML" align="top"></a>&nbsp;<a href="http://www.sugarcrm.com/crm/index2.php?no_html=1&stype=rss20&task=returnRSS&option=com_rss_feed_manager&channel=Training" target="_blank"><?php echo $mod_strings['LBL_SUGARCRM_TRAINING_NEWS']; ?></a></li>
...
<ul class="noBullet">
	<li class="noBullet" style="margin-bottom: 6px;"><a href="http://www.sugarcrm.com/crm/about/newsletter-registration.html" target="_blank"><?php echo $mod_strings['LBL_SUBSCRIBE_SUGARBUZZ']; ?></a><br></li>
...
<LI><?php echo $mod_strings['LBL_SOURCE_DOMIT']; ?> (<a href="http://sourceforge.net/projects/domit-xmlparser/" target="_blank">http://sourceforge.net/projects/domit-xmlparser</a>)</LI>
<LI><?php echo $mod_strings['LBL_SOURCE_DOMITRSS']; ?> (<a href="http://sourceforge.net/projects/domit-rssparser/" target="_blank">http://sourceforge.net/projects/domit-rssparser</a>)</LI>
...
<LI><?php echo $mod_strings['LBL_SOURCE_PHP_COMPAT']; ?> (<a href="http://pear.php.net/package/PHP_Compat/" target="_blank">http://pear.php.net/package/PHP_Compat/</a>) </LI>
