...
<script type="text/javascript" language="Javascript" src="include/SugarFields/Fields/Collection/SugarFieldCollection.js?"></script>
...
<script type="text/javascript" language="Javascript" src="include/javascript/quicksearch.js"></script>
...
<div id="contactsDialogueHTML" class="yui-hidden">
	<div id="contactsDialogueBody">
	   ...
	   <div id="addrSearchGrid"></div><div id='dt-pag-nav-addressbook'></div>
    </div>
</div>
