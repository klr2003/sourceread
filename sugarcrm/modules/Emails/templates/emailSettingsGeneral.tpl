...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="edit view">
	...
	<tr>
        <th colspan="4">
            <i style="font-weight:normal;">{$app_strings.LBL_EMAIL_SETTINGS_REQUIRE_REFRESH}</i>
        </th>
    </tr>

</table>
<input type="button" class="button" style="margin-left:5px;" value="   {$app_strings.LBL_EMAIL_SAVE}   " onclick="javascript:SUGAR.email2.settings.saveOptionsGeneral(true);">
