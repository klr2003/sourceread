...
$sugar_smarty->assign('SUBMIT_BUTTON','<input title="'.$app_strings['LBL_SAVE_BUTTON_TITLE'].'" class="button" onclick="if (!set_password(form,newrules(\''.'\',\''.'\',\''.'\'))) return false; this.form.saveConfig.value=\'1\';" type="submit" name="button" value="'.$app_strings['LBL_SAVE_BUTTON_LABEL'].'" />');
