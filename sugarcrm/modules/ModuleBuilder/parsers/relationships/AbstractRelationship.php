    ...
    function buildLabels ()
    {
        ...
        if (!$this->relationship_only)
        {
        	$labelDefinitions [] = array (
        		...
        		'display_label' => empty($this->lhs_label) ? translate ( $this->lhs_module ) : $this->lhs_label,
        	) ;
            $labelDefinitions [] = array (
            	'module' => $this->lhs_module ,
            	'system_label' => 'LBL_' . strtoupper ( $this->relationship_name . '_FROM_' . $this->getRightModuleSystemLabel() ) . '_TITLE' ,
            	'display_label' => empty($this->rhs_label) ? translate ( $this->rhs_module ) : $this->rhs_label,
            ) ;
        }
