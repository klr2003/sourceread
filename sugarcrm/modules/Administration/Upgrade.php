...
<tr>
	<td scope="row"><?php echo SugarThemeRegistry::current()->getImage('Repair','alt="'. $mod_strings['LBL_QUICK_REPAIR_AND_REBUILD'].'" align="absmiddle" border="0"'); ?>&nbsp;<a href="./index.php?module=Administration&action=repairSelectModule"><?php echo $mod_strings['LBL_QUICK_REPAIR_AND_REBUILD']; ?></a></td>
	<td> <?php echo $mod_strings['LBL_QUICK_REPAIR_AND_REBUILD_DESC'] ; ?> </td>
</tr>


<tr>
	<td scope="row"><?php echo SugarThemeRegistry::current()->getImage('Repair','alt="'. $mod_strings['LBL_REPAIR_DATABASE'].'" align="absmiddle" border="0"'); ?>&nbsp;<a href="./index.php?module=Administration&action=repairDatabase"><?php echo $mod_strings['LBL_REPAIR_DATABASE']; ?></a></td>
	<td> <?php echo $mod_strings['LBL_REPAIR_DATABASE_DESC'] ; ?> </td>
</tr>
<tr>
...
<!--
<tr>
	<td scope="row"><?php echo SugarThemeRegistry::current()->getImage('Repair','alt="'. $mod_strings['LBL_REPAIR_ENTRY_POINTS'].'" align="absmiddle" border="0"'); ?>&nbsp;<a href="./index.php?module=Administration&action=UpdateSugarEntry"><?php echo $mod_strings['LBL_REPAIR_ENTRY_POINTS']; ?></a></td>
	<td> <?php echo $mod_strings['LBL_REPAIR_ENTRY_POINTS_DESC'] ; ?> </td>
</tr>
-->

<tr>
	<td scope="row"><?php echo SugarThemeRegistry::current()->getImage('Rebuild','alt="'. $mod_strings['LBL_CLEAR_CHART_DATA_CACHE_TITLE'].'" align="absmiddle" border="0"'); ?>&nbsp;<a href="./index.php?module=Administration&action=clear_chart_cache"><?php echo $mod_strings['LBL_CLEAR_CHART_DATA_CACHE_TITLE']; ?></a></td>
	<td> <?php echo $mod_strings['LBL_CLEAR_CHART_DATA_CACHE_DESC'] ; ?> </td>
</tr>

<tr>
	<td scope="row"><?php echo SugarThemeRegistry::current()->getImage('Rebuild','alt="'. $mod_strings['LBL_CLEAR_TEMPLATE_DATA_CACHE_TITLE'].'" align="absmiddle" border="0"'); ?>&nbsp;<a href="./index.php?module=Administration&action=repairSelectModule&subaction=clearTpls"><?php echo $mod_strings['LBL_CLEAR_TEMPLATE_DATA_CACHE_TITLE']; ?></a></td>
	<td> <?php echo $mod_strings['LBL_CLEAR_TEMPLATE_DATA_CACHE_DESC'] ; ?> </td>
</tr>

<tr>
	<td scope="row"><?php echo SugarThemeRegistry::current()->getImage('Rebuild','alt="'. $mod_strings['LBL_CLEAR_THEME_CACHE_TITLE'].'" align="absmiddle" border="0"'); ?>&nbsp;<a href="./index.php?module=Administration&action=QuickRepairAndRebuild&subaction=repairAndClearAll&selected_actions[]=clearThemeCache&repair_module=<?php echo urlencode($mod_strings['LBL_ALL_MODULES']); ?>"><?php echo $mod_strings['LBL_CLEAR_THEME_CACHE_TITLE']; ?></a></td>
	<td> <?php echo $mod_strings['LBL_CLEAR_THEME_CACHE_DESC'] ; ?> </td>
</tr>

<tr>
	<td scope="row"><?php echo SugarThemeRegistry::current()->getImage('Rebuild','alt="'. $mod_strings['LBL_CLEAR_VARDEFS_DATA_CACHE_TITLE'].'" align="absmiddle" border="0"'); ?>&nbsp;<a href="./index.php?module=Administration&action=repairSelectModule&subaction=clearVardefs"><?php echo $mod_strings['LBL_CLEAR_VARDEFS_DATA_CACHE_TITLE']; ?></a></td>
	<td> <?php echo $mod_strings['LBL_CLEAR_VARDEFS_DATA_CACHE_DESC'] ; ?> </td>
</tr>

<tr>
    <td scope="row"><?php echo SugarThemeRegistry::current()->getImage('Rebuild','alt="'. $mod_strings['LBL_CLEAR_UNIFIED_SEARCH_CACHE_TITLE'].'" align="absmiddle" border="0"'); ?>&nbsp;<a href="./index.php?module=Administration&action=repairUniSearch"><?php echo $mod_strings['LBL_CLEAR_UNIFIED_SEARCH_CACHE_TITLE']; ?></a></td>
    <td> <?php echo $mod_strings['LBL_CLEAR_UNIFIED_SEARCH_CACHE_DESC'] ; ?> </td>
</tr>
...
<tr>
	<td scope="row"><?php echo SugarThemeRegistry::current()->getImage('Rebuild','alt="'. $mod_strings['LBL_REBUILD_AUDIT_TITLE'].'" align="absmiddle" border="0"'); ?>&nbsp;<a href="./index.php?module=Administration&action=RebuildAudit"><?php echo $mod_strings['LBL_REBUILD_AUDIT_TITLE']; ?></a></td>
	<td> <?php echo $mod_strings['LBL_REBUILD_AUDIT_DESC'] ; ?> </td>
</tr>
<tr>
...
<tr>
	<td scope="row"><?php echo SugarThemeRegistry::current()->getImage('Rebuild','alt="'. $mod_strings['LBL_REBUILD_EXTENSIONS_TITLE'].'" align="absmiddle" border="0"'); ?>&nbsp;<a href="./index.php?module=Administration&action=RebuildExtensions"><?php echo $mod_strings['LBL_REBUILD_EXTENSIONS_TITLE']; ?></a></td>
	<td> <?php echo $mod_strings['LBL_REBUILD_EXTENSIONS_DESC'] ; ?> </td>
</tr>
<tr>
