...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td>
						...
						<table id="sysGeneratedId" name="sysGeneratedName" width="100%" border="0" cellspacing="0" cellpadding="0" class="edit view">
							<tr>
							...
							<tr>
								<td>
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											<td colspan='4'>
												<table width="100%" id='syst_generated_pwd_table' border="0" cellspacing="0" cellpadding="0">
													<tr>
						...
						<table id="userResetPassId" name="userResetPassName" width="100%" border="0" cellspacing="0" cellpadding="0" class="edit view">
							<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<td>
					<tr>
						<table id="emailTemplatesId" name="emailTemplatesName" width="100%" border="0" cellspacing="0" cellpadding="0" class="edit view">
							<tr>
								<th align="left" scope="row" colspan="4">
									<h4>
												...
												<td colspan='4'>
													<table  cellspacing='0' cellpadding='0' id='ldap_display' style='display:{$ldap_display}' width='100%'>
														...
														<tr>
															...
															<td scope="row" valign='middle' nowrap></td>
