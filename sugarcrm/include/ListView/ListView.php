...
function getUserVariable($localVarName, $varName) {
	...
	function processSugarBean($xtemplateSection, $html_varName, $seed) {
		...
		$this->processListNavigation($xtemplateSection,$html_varName, $current_offset, $next_offset, $previous_offset, $row_count, null, null, empty($seed->list_fields) ? null : count($seed->list_fields)-1);
